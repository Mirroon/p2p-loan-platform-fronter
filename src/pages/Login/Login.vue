<template>
    ...
    <div class="center">
        <el-form v-show="Login === 'SignIn'" :model="SignIn" label-width="7em" ref="SignIn" :rules="signin_rules">
            <el-form-item>
                <h1 class="h2 font-weight-normal mb-5">登录</h1>
            </el-form-item>
            ...
            <el-form-item>
                <p class="mt-5 mb-3 text-muted">&copy; 仅供内部测试使用</p>
            </el-form-item>
        </el-form>
                        ...
                        reqLogin({
                            ...
                            password: this.SignIn.password
                                ...
                                if (data.code===0) {
                                    ...
                                    this.$store.commit('Person/setAccount', this.SignIn.account)
                                    this.$store.commit('ShopCart/initCart')
                ...
                this.$refs[formName].validate((valid) => {
                    if (valid) {
                        reqSignup({
                            ...
                            repeatPassword:this.SignUp.confirm_password
                        }).then((data) => {
                            if (data.code===0) {
                                this.$alert('注册成功', {
